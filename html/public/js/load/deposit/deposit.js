...
function deposit(not_id, flag) {
    ...
    Notfification_Modal({
        ...
        title: '',
        labels: [],
        loadType: 'Cash Deposit',
        keyboard: true,
        backdrop: 'dynamic',
        //forms: formElement,
        sms: 'Are you sure?'
    });
    $('form#sexpense .modal-footer').html('<input type="submit" id="ok" name="ok" value="OK" class="btn btn-warning">');
