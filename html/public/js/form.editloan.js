            ...
            contract_id:{
                ...
                remote:{
                    ...
                    data:
                    {
                        ...
                        id: function()
                        {
                            return $('#addloanForm :input[name="lid"]').val();
                        },
                        _token:function(){
...
/*$.validator.addMethod('isValidDigit',function(value){
    var contract_id_pattern = /^[a-zA-Z][0-9]{5}[0-9]$/;
...
$.validator.addMethod('isBalloon',function(){
    ...
    if(repay_type == 3 || repay_type ==4 || repay_type == 5)
        return true;
    return false;
},'Please choose one');
...
$.validator.addMethod("check_tenure", function(value, element)
{
    ...
    repayment_date = $('#t-result input[name="repayment_date[]"]').length;
    if(repayment_date > 0 && loan_duration != repayment_date) return false;
    return true;
