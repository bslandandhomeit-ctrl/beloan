    ...
    bindEvent: function(){
        ...
        $("#balloon").on('keyup',function(e){
            ...
            if(balloon_new != '' && balloon_new !='undefined'){
                var balloon_amount = $("#loan_amounts").val()/ balloon_new;
...
//
//                            		loan_amounts = parseFloat(loan_amounts) - parseFloat(res_i.principal);
//                            		row_j.find('.col_5 .can-edit').text(parseFloat(loan_amounts).toFixed(2));
//                            	}
//                            }
//                        });
//                    }
