...
$.extend(Loan.prototype,{
    ...
    bindEvent: function () {
        ...
        self.$tab.on('shown.bs.tab',function(e) {
            ...
            if (target == "#schedule") {
                if(self.repaySchedule == false){
                    ...
                    if(repay != '') {
                        ...
                        self.$loading.show();
                        var url = '/api/loan/reschedule/' + id;
                        console.log(self);
            ...
            }else if(target == "#customertranfer"){
                if(self.customertranfer == false){
                    self.$loading.show();
                    var url = '/api/loan/customertranfer/'+id;
                    var data = {_token: token};
                    self.customerTranfer(url,data,$("#customertranfer"));
                }
            ...
            }else if(target == "#statement_tap"){
                if(self.statement ==  false){
                    self.$loading.show();
                    var url = '/api/loan/statement/'+id;
                    var data = {_token: token,dpDate:dpDate};
                    self.statementTap(url,data,$("#statement_tap"));
                }
            }
        });
    ...
    statementTap: function(url,data,content){
        var self = this;
        $.ajax({
            url: url,
            type:'POST',
    ...
    customerTranfer: function(url,data,content){
        var self = this;
        $.ajax({
            url: url,
            type:'POST',
...
$(document).ready(function(){
    ...
    $(".guarantor-signature").magnificPopup({type: 'image',image:{cursor:'mfp-auto-cursor'}});
    $(".borrower-signature").magnificPopup({type: 'image',image:{cursor:'mfp-auto-cursor'}});
    $('.view-map').on('click',function(e){
        e.preventDefault();
        var lat = $(this).attr('data-lat');
        var long = $(this).attr('data-long');
