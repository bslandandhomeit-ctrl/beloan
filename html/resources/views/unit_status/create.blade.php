        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    {{ trans('unit_status.unit_status') }} : {{ trans('unit_status.add_new') }}
                </header>
                <div class="panel-body">
                    ...
                    <form class="cmxform form-horizontal" method="post" action="{{route('add_unit_status')}}" id="frmDealer" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit_status.status') }}<span class="red-color"> *</span></label>
                                    <input type="text" id="status" name="status" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit_status.description') }}</label>
