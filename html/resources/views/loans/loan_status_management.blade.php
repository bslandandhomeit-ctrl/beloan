...
<section class="panel">
    ...
    <div class="panel-body">
        <div class="position-center" style="width:95%;">
            <form role="form" class="cmxform form-horizontal" method="get" action="{{ route('loan_status') }}" id="search_frm">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="client_name" class="col-lg-4 control-label">{{ trans('multiple.m_client_name') }}</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" id="client_name" name="client_name" value="{{$client_name}}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="contract_id" class="col-lg-4 control-label">{{ trans('report.rpt_contract_id') }}</label>
                            <div class="col-lg-8">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="project_id" class="col-lg-4 control-label">Project</label>
                            <div class="col-lg-8">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="unit_type_id" class="col-lg-4 control-label">{{ trans('unit.unit_type') }}</label>
                            <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="unit_id" class="col-lg-4 control-label">{{ trans('unit.unit') }}</label>
                            <div class="col-lg-8">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="contact_date" class="col-lg-4 control-label">{{ trans('loan.l_contact_date') }}</label>
                            <div class="col-lg-8">
                                {{-- <input type="text" class="form-control" id="contact_date" name="contact_date"/> --}}
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="date" class="col-lg-4 control-label">{{ trans('multiple.date') }}</label>
                            <div class="col-lg-8">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="inputCardnumber" class="col-lg-4 control-label">{{ trans('multiple.m_status') }}</label>
                            <div class="col-lg-8">
        ...
        <section id="unseen" class="ox-scroll">
          <div id="printArea">
            ...
            <table  class="table table-striped table-bordered" style="width:100%">
                ...
                <th style="text-align: center; vertical-align: middle;">{{ trans('loan.main_project_code') }}</th>
