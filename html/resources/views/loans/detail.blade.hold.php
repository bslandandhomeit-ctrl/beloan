        ...
        <header class="panel-heading">
            ...
            @if(!empty($static) && !empty($static['loan_status']) &&
                ...
                <span class="red-color"
                      style="font-weight: bold;"> ( {{ $static['loan_status'][$loan->status] }} )</span>
            @endif
        </header>
            ...
            @if(!empty($loan))
                <div class="row">
                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    {{-- @if($loan->status == 7)
                                        <li>
                                            <a href="{{ route('loan_reschedule_approve',[$loan->id]) }}"
                                               class="approval">
                                                <i class="fa fa-adn"></i>
                                                {{ trans('loan.l_approve')  }}
                                            </a>
                                    ...
                                    <li>
                                        @if($loan->status == 5)
                                            <a href="{{ route('loan_writeoff_pay',[$loan->id]) }}"><i
                                                        class="fa fa-plus"></i>&nbsp;{{ trans('multi.write-off_pay') }}
                                            </a>
                                        @endif
                                    </li>
                                    <?php
                                    ...
                                    @if(in_array($loan->status, array(3, 8)))
                                        <li class="dropdown">
                                            <a href="javascript:;" class="dropdown-toggle"
                                               data-toggle="dropdown">{{ trans('loan.l_more') }} <b
                                                        class="caret"></b></a>
                                            ...
                                            <!-- <li><a href="{{ route('loan_writeoff',[$loan->id]) }}">{{ trans('sidebar.sb_write-off_loans') }}</a></li> -->
                                                ...
                                                @endif
                                                <li><a href="#update-parc"
                                                       data-toggle="modal">{{ trans('loan.l_update_step') }}</a></li>
                                            </ul>
                                        </li>
                                    @endif
                    ...
                    <!--<div class="pull-right">
                      <button class="btn btn-warning" id="myprint"><i class="fa fa-print"></i> {{ trans('multiple.m_print') }}</button>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="fileupload-new thumbnail" style="width: 150px;">
                                                    <img src="{{ !empty($loan->client->general->first()->photo)?asset('/data/clients/'.$loan->client->general->first()->photo, isset($secure) ? false : false):asset('images/noimage.gif', isset($secure) ? false : false) }}"
                                                         alt="Profile Picture"/>
                                                    ...
                                                    <div class="col-md-4">
                                                        <table class="table-condensed">
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if(!empty($loan->client->general->first()->country))
                                                                    <td>{{ !empty($loan->client->general->first()->country->description->first()->name)?$loan->client->general->first()->country->description->first()->name:'N/A' }}</td>
                                                                @else
                                                                    <td>N/A</td>
                                                                @endif
                                                            </tr>
