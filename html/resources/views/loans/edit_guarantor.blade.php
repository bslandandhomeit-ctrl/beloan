...
@section('content')
    <section class="panel">
        ...
        <header class="panel-heading">
            {{ trans('loan.l_edit_guarantor') }}
        </header>
        <div class="panel-body">
            <form class="cmxform form-horizontal" method="post" action="{{ route('edit_guarantor', [$edits->id]) }}" id="frmGuarantor" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <input type="hidden" name="id" value="{{$edits->id}}">
                <input type="hidden" name="loan_id" value="{{$edits->loan_id}}">
                <fieldset>
                    <div class="row">
                        <!-- Grid to left -->
                        <div class="col-sm-6">
                                ...
                                <div class="col-sm-2">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="{{ $edits->photo?asset('data/guarantors/'.$edits->photo, isset($secure)?false:false):asset('images/noimage.gif', isset($secure)?false:false) }}" alt="" />
                                        </div>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" name="relationship" id="relationship_type">
                                        ...
                                        @foreach($static['relationship_type'] as $key => $value)
                                            <option value="{{ $value }}" {{$edits->relationship ? $edits->relationship == $value ? 'selected' : '' : old('relationship_type')}}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="kh_name" value="{{$edits->kh_name}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" name="gender">
                                        ...
                                        @foreach($static['gender'] as $key => $value)
                                            <option value="{{ $value }}" {{$edits->gender ? $edits->gender == $value ? 'selected' : '' : old('gender')}}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="nationality" value="{{$edits->nationality}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" class="input-append date dpYears col-md-8">
                                    <input type="text" name="birth_date" value="{{$edits->birth_date}}" size="16" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="birth_place" value="{{$edits->birth_place}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('multiple.m_phone',['num'=>1]) }}<span class="red"> *</span></label>
                                <div class="col-md-8">
                                    <input type="text" name="phone1" value="{{$edits->phone1}}" id="phone1" class="form-control" data-mask="999-999-999?9">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('multiple.m_phone',['num'=>2]) }}</label>
                                <div class="col-md-8">
                                    <input type="text" name="phone2" value="{{$edits->phone2}}" class="form-control" data-mask="999-999-999?9">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('multiple.m_address') }}<span class="red"> *</span></label>
                                <div class="col-md-8">
                                    <textarea name="address" id="address" class="form-control">{{$edits->address}}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- Grid to right  -->
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="{{ $edits->signature?asset('data/guarantors_signature/'.$edits->signature, isset($secure)?false:false):asset('images/noimage.gif', isset($secure)?false:false) }}" alt="" />
                                        </div>
                                        <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                        <div>
                                           <span class="btn btn-white btn-file">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="location_latitude" value="{{$edits->location_latitude}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('customer.cus_longitude') }}</label>
                                <div class="col-md-8">
                                    <input type="text" name="location_longitude" value="{{$edits->location_longitude}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('customer.cus_job') }}</label>
                                <div class="col-md-8">
                                    <input type="text" name="job" value="{{$edits->job}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('customer.cus_work_place') }}</label>
                                <div class="col-md-8">
                                    <input type="text" name="work_place" value="{{$edits->work_place}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('customer.cus_card_number') }}</label>
                                <div class="col-md-8">
                                    <input type="text" name="card_number" value="{{$edits->card_number}}" id="card_number" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('customer.cus_issued_date') }}</label>
                                <div data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" class="input-append date dpYears col-md-8">
                                    <input type="text" name="card_date" value="{{$edits->card_date}}" size="16" class="form-control">
                                        <span class="add-on birhtdateDatepicker">
                                            <button class="btn btn-primary" type="button"><i class="fa fa-calendar"></i></button>
                                        </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="card_issued_by" value="{{$edits->card_issued_by}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('customer.cus_card_expired_date') }}</label>
                                <div data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" class="input-append date dpYears col-md-8">
                                    <input type="text" name="card_expired_date" value="{{$edits->card_expired_date}}" size="16" class="form-control">
                                        <span class="add-on birhtdateDatepicker">
                                            <button class="btn btn-primary" type="button"><i class="fa fa-calendar"></i></button>
                                        </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="letter_no" value="{{$edits->letter_no}}" class="form-control" placeholder="Enter letter no">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">{{ trans('customer.cus_expired_date') }}</label>
                                <div data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" class="input-append date dpYears col-md-8">
                                    <input type="text" name="expired_date" value="{{$edits->expired_date}}" size="16" class="form-control">
                                        <span class="add-on birhtdateDatepicker">
                                            <button class="btn btn-primary" type="button"><i class="fa fa-calendar"></i></button>
                                        </span>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="col-sm-3"></div>
                            <button type="submit" id="submit" class="btn btn-success"><i class="fa fa-save"></i> {{ trans('multiple.m_update') }}</button>
