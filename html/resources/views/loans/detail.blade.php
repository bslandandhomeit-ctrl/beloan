                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <?php
                                        ...
                                        echo $html;
                                    ?>
                                      @if(in_array($loan->status, array(9, 10)))
                                    <li>
                                        <a href="{{route('print_payoff_letter',[$loan->id])}}"><i class="fa fa-print"></i>&nbsp; Payoff Letter
                                        </a>
                                    </li>
                                    @endif
                    ...
                    <div class="panel-body">
                        ...
                        <div id="printArea" class="printArea">
                            ...
                            <?php $data=[
                                ...
                                'projects_row'=>$loan->projects                         
                            ]                              
                            ?>
                            @include('api.report_header_custom_v2', $data)
...
function discount(){
    ...
    var drawdown_amount=$("#drawdown_amount").val();
    
    var net_outstanding_balance=parseFloat($("#outstanding_balance").val())-parseFloat(total_dic) + parseFloat(interest_accrual) - parseFloat(drawdown_amount);
