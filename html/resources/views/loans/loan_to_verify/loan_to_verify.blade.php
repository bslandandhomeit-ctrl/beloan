...
<section class="panel">
    <header class="panel-heading">
        <span>{{ trans('sidebar.sb_loan_verify_summary') }}</span>
    </header>
    <div class="panel-body">
        ...
        <section id="unseen" class="ox-scroll">
            ...
            <div id="printArea">
                ...
                <table  class="table table-striped table-bordered" style="width:100%" id="loan_to_verify">
                    <thead>
                    ...
                    <tbody style="vertical-align: middle">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;text-align: center">
                                <a style="text-decoration: underline" href="{{ route('loan_verify_detail', [$l->id])}}">{{ $l->contract_id ? $l->contract_id : '-'  }}</a>
                            </td>
                            <td style="vertical-align: middle;text-align: center">
...
//pagination
    ...
    $("#export").click(function (event) {
        ...
        if(con == true){
            new TableExport(document.getElementById('loan_to_verify'), {
                formats: ['csv'],
                filename:'loan_to_verify'
            });
