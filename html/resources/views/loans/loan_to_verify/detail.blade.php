                        ...
                        <div class="col-md-4">
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td>{{ !empty($loan->contract_deadline)  ? date('d-M-Y',strtotime($loan->contract_deadline)) : "-" }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
