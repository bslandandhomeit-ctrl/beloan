...
@section('content')
    <section class="panel">
        ...
        <header class="panel-heading">
           {{ trans('loan.l_add_guarantor_collateral') }}
        </header>
        <div class="panel-body">
            <form class="cmxform form-horizontal" method="post" action="{{ route('add_guarantor_collateral', [$id]) }}" id="frmGuarantorCollateral" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="collateral_no[]" id="collateral_no" class="form-control"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{ trans('loan.l_guarantor_collateral_value') }}<span class="red-color">*</span></label>
                    <div class="col-sm-6">
                        <input type="text" name="collateral_value[]" id="collateral_value" class="form-control"/>
                    </div>
                </div>
                <div class="form-group">
