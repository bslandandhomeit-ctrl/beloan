                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="fileupload-new thumbnail" style="width: 200px;">
                                            <img src="{{ $loan->client->photo?asset('/data/clients/'.$loan->client->photo, isset($secure)?false:false):asset('images/noimage.gif', isset($secure)?false:false) }}" alt="Profile Picture"/>
                                        </div>
                                         ...
                                         <a href="javascript:;" class="client-view"
                                                data-mfp-src="{{ asset('data/signatures/'.$loan->client->signature, isset($secure)?false:false)}}"
