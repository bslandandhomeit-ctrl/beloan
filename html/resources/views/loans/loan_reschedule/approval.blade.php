...
@section('content')
    <section class="panel">
        <header class="panel-heading">
            {{ trans('loan.l_approval_reschecdule') }}
        </header>
        ...
        <div class="panel-body">
            ...
            @endif
            <form class="cmxform form-horizontal" method="post" action="{{ route('reschedule_approval',[$loan->id]) }}" id="addApprovalLoanForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-append date dpYears col-sm-6" data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" data-date="{{date('Y-m-d')}}">
                        <input type="text" value="{{date('Y-m-d')}}" class="form-control" name="approval_date" id="approval_date" required>
