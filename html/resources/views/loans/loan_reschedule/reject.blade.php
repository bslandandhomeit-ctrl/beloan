...
@section('content')
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            @endif
            <form class="cmxform form-horizontal" method="post" action="{{ route('reschedule_rejected',[$id]) }}" id="frmReject">
                ...
                <div class="form-group">
                    ...
                    <div class="input-append date dpYears col-sm-6" data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" data-date="{{date('Y-m-d')}}">
                        <input type="text" value="{{ date('Y-m-d') }}" class="form-control" name="reject_date" id="reject_date">
