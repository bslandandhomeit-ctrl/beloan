...
@section('content')
    <section class="panel">
        <header class="panel-heading">
           {{ trans('loan.l_reschedule_approve') }}
        </header>
        ...
        <div class="panel-body">
            ...
            <form class="cmxform form-horizontal" method="post" action="{{ route('loan_reschedule_approve',[$loan->id]) }}" id="frmRescheduleApprove">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{ trans('loan.l_approve_on') }} <span class="red">*</span></label>
                    <div class="input-append date dpYears col-sm-6" data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" data-date="{{date('Y-m-d')}}">
                        <input type="text" value="{{ date('Y-m-d') }}" class="form-control" name="approval_date" id="approval_date">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" readonly value="{{ $loan->loan_amount }}" class="form-control" name="amount" id="amount" />
                    </div>
                </div>
                <div class="form-group">
