...
<section class="panel">
    <header class="panel-heading">
        <span>{{ trans('sidebar.sb_loan_send_back_summary') }}</span>
    </header>
    <div class="panel-body">
        <div class="position-center" style="width:90%;">
            <form role="form" class="cmxform form-horizontal" method="get" action="{{ route('loan_verify') }}" id="search_frm">
                <div class="row">
                    <div class="col-lg-5">
        ...
        <section id="unseen" class="ox-scroll">
            ...
            <div id="printArea">
                ...
                <table  class="table table-striped table-bordered" style="width:100%" id="loan_to_reject_summary">
                    <thead>
                    ...
                    <tbody style="vertical-align: middle">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;text-align: center">
                                <a style="text-decoration: underline" href="{{ route('loan_reject_detail', [$l->id])}}">{{ $l->contract_id ? $l->contract_id : '-'  }}</a>
                            </td>
                            <td style="vertical-align: middle;text-align: center">
...
//pagination
    ...
    $("#export").click(function (event) {
        ...
        if(con == true){
            new TableExport(document.getElementById('loan_to_reject_summary'), {
                formats: ['csv'],
                filename:'loan_to_reject_summary'
            });
