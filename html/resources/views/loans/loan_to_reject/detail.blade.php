            ...
            @if(!empty($loan))
                ...
                <section>
                    <ul class="nav nav-tabs">
                        ...
                        <li id="do_audit"><a data-toggle="tab" href="#audit">{{ trans('multiple.m_reason') }}</a></li>
                    </ul>
                        ...
                        <div id="printArea" class="printArea">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="audit" class="tab-pane">
                                    <h5><strong>{{ trans('multiple.m_reason') }}</strong></h5>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click','#submit_to_reject',function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.status == true){
                        window.location.href = '{{ route('loan_verify') }}';
                    }
                }
            });            
        });
