   ...
   <div class="row">
      <div class="col-sm-12">
         <section class="panel reloaddive">
            <header class="panel-heading"><span>{{ trans('Withdraw') }}</span></header>
               <div class="panel-body">
                  <form action="" class="cmxform form-horizontal swithdraw" enctype="form-data" id="swithdraw" method="post" name="swithdraw" onsubmit="return false;" style="margin-bottom: 0px;">
                     <input type="hidden" name="_token" value="{{ csrf_token() }}">
                     <div class="container">
                        <div class="row">
                           <div class="col-lg-2 col-sm-2 col-xs-2" style="padding:14px 0px 0px 22px;">
                              <div class="form-group" style="height:42px;">
                                 <label for="Date" style="height:30px;">Date</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="To" style="height:30px;">To</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="Notify to" style="height:30px;">Notify to</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="Withdraw type" style="height:30px;">Withdraw type</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="Withdraw account" style="height:30px;">Withdraw account</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="Drawdown Account" style="height:30px;">Drawdown Account</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="Currency type" style="height:30px;">Currency type</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="Amount" style="height:30px;">Amount</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                              <div class="form-group" style="height:42px;">
                                 <label for="Description" style="height:30px;">Description</label> <label style="float: right; margin-right:69px;">:</label>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-4 col-xs-5" style="padding-right: 36px;">
                              <div class="input-append date dpYears form-group" data-date-format="yyyy/mm/dd" data-date-viewmode="years" data-initialize="datepicker" id="start_date">
                                 <input class="form-control" id="till_date" name="till_date" type="text" value="2021/09/20 11:36:09"><span class="add-on offonDatepicker"><button class="btn btn-primary" type="button"><span class="add-on offonDatepicker"><i class="fa fa-calendar"></i></span></button></span>
                              </div>
                              <div class="form-group">
                                 <select class="select2" id="client" name="client">
                                    <option value="">
                                       Choose one
                                    </option>
                                 </select>
                              ...
                              <div class="form-group">
                                 <input class="form-control" disabled id="customer" name="customer" placeholder="" style="" type="text" value="">
                              </div>
                              <div class="form-group">
                                 <input class="form-control" disabled id="drawdown_acc" name="drawdown_acc" placeholder="" style="" type="text" value="">
                              </div>
                              <div class="form-group">
                                 <input class="form-control" disabled id="currency" name="currency" placeholder="" style="" type="text" value="">
                              </div>
                              <div class="form-group">
                                 <input class="form-control" disabled id="amount" name="amount" placeholder="" style="" type="text" value="0">
                              </div>
                              <div class="form-group">
                                 <textarea class="form-control" id="descr" name="descr" rows="10"></textarea>
                              </div>
                           </div>
