        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    {{ trans('representative.sale_representative') }} : {{ trans('representative.edit') }}
                </header>
                <div class="panel-body">
                    ...
                    <form class="cmxform form-horizontal" method="post" action="{{route('edit_representative',[$representative->id])}}" id="frmDealer" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $representative->name_en }}" id="name_en" name="name_en" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ $representative->dob }}" id="dob" name="dob" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <label class="control-label">{{ trans('representative.issued_date') }} <span
                                    class="red-color">*</span></label>
                                <input type="date" value="{{ $representative->national_issued_date }}" id="national_issued_date" name="national_issued_date" class="form-control" required/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php 
                                        ...
                                        $national_back = '';
                                        $contract = '';
                                        if($representative->national_front){
                                            if(file_exists('data/representative/national_front/'.$representative->national_front)){
                                                $national_front = asset('data/representative/national_front/'.$representative->national_front);
                                            }else{
                                        ...
                                        if($representative->national_back){
                                            if(file_exists('data/representative/national_back/'.$representative->national_back)){
                                                $national_back = asset('data/representative/national_back/'.$representative->national_back);
                                            }else{
                                        ...
                                        if($representative->contract){
                                            if(file_exists('data/representative/contract/'.$representative->contract)){
                                                $contract = asset('data/representative/contract/'.$representative->contract);
                                            }else{
