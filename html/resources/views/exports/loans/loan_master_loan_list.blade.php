...
<table>
    ...
    <th style="text-align: center; vertical-align: middle;">{{ trans('multiple.m_no') }}</th>
                ...
                <th style="text-align: center; vertical-align: middle;">DD.Account</th>
                <th style="text-align: center; vertical-align: middle;">{{ trans('report.rpt_contract_id') }}</th>
                <th style="text-align: center; vertical-align: middle;">Loan ID</th>
                <th style="text-align: center; vertical-align: middle;">Customer No</th>
                ...
                <th style="text-align: center; vertical-align: middle;">Co-Borrower Name</th>
                <th style="text-align: center; vertical-align: middle;">Co-Borrower Phone</th>  
                <th style="text-align: center; vertical-align: middle;">Co-Borrower Address</th> 
                ...
                <th style="text-align: center; vertical-align: middle;">Sale Team</th>    
                <th style="text-align: center; vertical-align: middle;">Sale Person</th>
                <th style="text-align: center; vertical-align: middle;">Commission</th>
                ...
                <th style="text-align: center; vertical-align: middle;">Remark (Discount)</th>                                                    
                ...
                <th style="text-align: center; vertical-align: middle;">Verify By</th>
                <th style="text-align: center; vertical-align: middle;">Verify Date</th>
                ...
                <th style="text-align: center; vertical-align: middle;">Disburse by</th>
                <th style="text-align: center; vertical-align: middle;">Disburse Date</th>
                <th style="text-align: center; vertical-align: middle;">Status Remark</th>
                <th style="text-align: center; vertical-align: middle;">Status Remark 2</th>
                ...
                <tbody style="vertical-align: middle">
                    ...
                    @forelse($loans as $l)
                        ...
                        <?php
                            ...
                            if(!empty($l->transaction) && count($l->transaction) > 0){
                                if($l->transaction[0]->trans_type==='Pay-Off'){
                                 $outstanding_Interest=floatval($l->transaction[0]->balance) > 0 ? floatval($l->transaction[0]->balance) : 0;
                                }
                            ...
                            //         $current_schedule_date=current_schedule_date($l->schedule);
                            //         $schedule_date=$current_schedule_date;
                            //     }
                            // }else{
                            ...
                            // $schdule_amount=floatval($interest) + floatval($principal);
                        ...
                        // if(!empty($l->schedule) && count($l->schedule) > 0){
                        //     $arrea_schedule=findObjectById($l->payment->max('payment_month'),$l->schedule);
                        //     if(!empty($arrea_schedule) && count($arrea_schedule) > 0){
                        //         $arrea_schedule_date=$arrea_schedule->schedule_date;   
                        //         $rdate = new DateTime($arrea_schedule_date);
                        ...
                        //     }else{
                        //         $arrea_schedule_date=$l->schedule[0]->schedule_date;   
                        //         $rdate = new DateTime($arrea_schedule_date);
                        //         $rdate->modify('+1 month');
                        //         $next_schedule_date=$rdate;
                        //         $Arrear_Date=$next_schedule_date; 
                    ...
                    $contract_deadline_total = date("Y-m-d", strtotime("+".number_format($l->extended_deadline,0)." month", $time));
                            ...
                            <td style="vertical-align: middle;text-align: center;">
                                <a style="text-decoration: underline" href="{{ route('loan_account', [$l->loan_account_id])}}">
                                    {{ !empty($l->drawdown_acc)?$l->drawdown_acc:"-" }}
                                </a>
                            </td>
                            <td style="vertical-align: middle;text-align: center">
                            ...
                            <td style="vertical-align: middle;text-align: center">
                                <a style="text-decoration: underline" href="{{ route('loan_detail', [$l->id])}}">{{ $l->id ? $l->id : '-'  }}</a>
                            </td>
                            <td style="vertical-align: middle">{{$l->cus_acc}}</td>
                            ...
                            <td style="vertical-align: middle;text-align: center">{{ !empty($l->short_code)?$l->short_code:"-" }}</td>
                            <td style="vertical-align: middle;text-align: center">{{ !empty($l->name)?$l->name:"-" }}</td>
                            <td style="vertical-align: middle">{{$l->client_name}}</td>
                            <td style="vertical-align: middle">{{$l->phone1}}</td>
                            <td style="vertical-align: middle">{{$l->address}}</td>
                            <td style="vertical-align: middle">{{$l->co_borrowers?$l->co_borrowers->Clients->client_name:''}}</td>
                            <td style="vertical-align: middle">{{ $l->co_borrowers->Clients->phone1}}{{ !empty($l->co_borrowers->Clients->phone2)? ' / '. $l->co_borrowers->Clients->phone2:''}}</td>
                            <td style="vertical-align: middle">{{$l->co_borrowers->Clients->address}}</td>                            
                            ...
                            <td style="text-align: center">{{$l->handover_dateline ? $l->handover_dateline : ''}}</td>
                            <td style="text-align: center">{{$l->extended_deadline ? number_format($l->extended_deadline,0) : ''}} </td>
                            ...
                            <td style="text-align: center">{{ !empty($l->co_user->name) ? $l->co_user->name : '-' }}</td>
                            <td style="text-align: center">{{ !empty($l->sale_persons->name) ? $l->sale_persons->name : '-' }}</td>
                            ...
                            <td style="text-align: center">{{ ($outstanding_Interest > 0) ? number_format($outstanding_Interest, 2, '.', '') : 0 }}</td>
                            ...
                            <td style="text-align: center">{{($l->client_loan_account->balance > 0) ? number_format($l->client_loan_account->balance, 2, '.', '') : 0 }}</td>
                            <td style="text-align: center">{{ ($totalall_outstanding > 0) ? number_format($totalall_outstanding, 2, '.', '') : 0 }}</td>
                            <td style="text-align: center;white-space: nowrap;">{{ number_format($l->penalty_rate1,2,'.','') }}</td>
                            <td style="text-align: center">{{$schedule_date ? date("d-m-Y", strtotime($schedule_date)) : '-'}}</td>
                            <td style="vertical-align: middle;text-align: center">{{ $l->payment?$l->payment[0]->paid_interest:0 }}</td>
                            <td style="vertical-align: middle;text-align: center">{{ $l->payment?$l->payment[0]->paid_principal:0 }}</td>
                            ...
                            <td style="text-align: center"> {{number_format($l->loan_drawdow_acc->balance,2,'.','')}}</td>
