...
<section class="panel">
    ...
    <div class="panel-body">
        <form role="form" action="{{ route('view_journal') }}" id="search_frm">
            <div class="row">
                ...
                <label class="control-label col-md-1">{{ trans('report.rpt_transaction_id') }}</label>
                <div class="col-md-2">
                    <input type="text" name="id" class="form-control" value="{{ isset($tran_id)?$tran_id:'' }}" />
                </div>

                <label class="control-label col-md-1">{{ trans('report.rpt_entry_id') }}</label>
                <div class="col-md-2">
                    <input type="text" name="entry_id" class="form-control" value="{{ isset($entry_id)?$entry_id:'' }}" />
                </div>

                <label class="control-label col-md-1">{{ trans('account.ref_id') }}</label>
                <div class="col-md-2">
