...
@section('js')
    ...
    $('#button').click(function(){
        ...
        function get_penalties(){
            ...
            window.history.pushState("", "", `?dpDate=${dpDate}&penalty_days=${penalty_days}&penalty_month=${penalty_month}`);
        }
                 ...
                 <div class="row">\
                    ...
                    <table class="table table-bordered table-striped table-condensed payoff_repayment">\
                        ...
                        <tbody>\
                            ...
                            <tr>\
                                <th>{{ trans('loan.total')  }}</th><th style="color:red; text-align: right;">$ '+ (payoff.totalPayOff + down_payment).toFixed(2) +'</th>\
                            </tr>\
                        </tbody>\
                    </table>\
                     </div>\
