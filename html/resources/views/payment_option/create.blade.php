        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    {{ trans('payment_option.create_pay_option') }}
                </header>
                <div class="panel-body">
                    ...
                    <form class="cmxform form-horizontal" method="post" action="{{route('add_payment_option')}}" id="frm_payment">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="unit_type_id">
                                        @foreach($unit_type as $unit_types)
                                            <option value="{{ $unit_types->id }}">{{ $unit_types->name }} ({{ isset($unit_types->Projects->dealer)?$unit_types->Projects->dealer:'' }})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="initial_deposit_amount" name="initial_deposit_amount" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="flat-green single-row icheck group">
                                    <div class="radio">
                                        <input type="checkbox" name="first_payment_plan">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first_pay_duration_month" name="first_payment_duration_month" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('payment_option.first_pay_per') }}:<span class="red-color"> *</span></label>
                                    <input type="text" id="first_pay_per" name="first_payment_per" class="form-control" required/>
                                </div>
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="loan_duration" name="loan_duration_month" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('payment_option.interest_per_year') }}<span class="red-color"> *</span></label>
                                    <input type="text" id="interest_per_year" name="interest_per_year" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('payment_option.special_discount') }}<span class="red-color"> *</span></label>
                                    <input type="text" id="special_discount" name="special_discount" class="form-control" required/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
