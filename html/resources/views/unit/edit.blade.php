        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    {{ trans('unit.edit_unit') }} : {{ $unit->code }}
                </header>
                <div class="panel-body">
                    ...
                    <form class="cmxform form-horizontal" method="post" action="{{route('edit_unit',[$unit->id])}}" id="frm_unit">
                        ...
                        <div class="row">
                                ...
                                <div class="input-group">
                                    <select id="unit_type_id" style="width: 100%" name="unit_type_id">
                                        @foreach($unit_type as $unit_types)
                                            <option value="{{ $unit_types->id }}" {{ $unit_types->id?$unit_types->id == $unit->unit_type_id?'selected':'':old('unit') }}>{{ $unit_types->name }} ({{ isset($unit_types->Projects->dealer)?$unit_types->Projects->dealer:''}} - {{  isset($unit_types->Projects->short_code)?$unit_types->Projects->short_code:'' }} )</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $unit->zone_id }}" id="zone_id" name="zone_id" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.unit_code') }}<span class="red-color"> *</span></label>
                                    <input type="text" value="{{ $unit->code }}" id="unit_code" name="unit_code" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.price') }}<span class="red-color"> *</span></label>
                                    <input type="text" value="{{ $unit->price }}" id="price" name="price" class="form-control" required/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $unit->street }}" id="street" name="street" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.street_corner') }}</label>
                                    <input type="text" value="{{ $unit->street_corner }}" id="street_corner" name="street_corner" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.street_size') }}</label>
                                    <input type="text" value="{{ $unit->street_size }}" id="street_size" name="street_size" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.floor') }}</label>
                                    <input type="text" value="{{ $unit->floor }}" id="floor" name="floor" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $unit->land_size_width }}" id="land_width" name="land_width" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.land_length') }} : ({{ trans('បណ្ដោយដី') }}):</label>
                                    <input type="text" value="{{ $unit->land_size_length }}" id="land_length" name="land_length" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.land_area') }} : ({{ trans('ទំហំដី') }}):</label>
                                    <input type="text" value="{{ $unit->land_area }}" id="land_area" name="land_area" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $unit->building_size_width }}" id="house_width" name="house_width" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.house_length') }} : ({{ trans('បណ្ដោយផ្ទះ') }}):</label>
                                    <input type="text" value="{{ $unit->building_size_length }}" id="house_length" name="house_length" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.house_area') }}​ : ({{ trans('ទំហំផ្ទះ') }}):</label>
                                    <input type="text" value="{{ $unit->building_area }}" id="house_area" name="house_area" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $unit->living_room }}" id="living_room" name="living_room" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.kitchen') }}</label>
                                    <input type="text" value="{{ $unit->kitchen }}" id="kitchen" name="kitchen" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.bedroom') }}</label>
                                    <input type="text" value="{{ $unit->bedroom }}" id="bedroom" name="bedroom" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $unit->bathroom }}" id="bathroom" name="bathroom" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('unit.swimming_pool') }}</label>
                                    <input type="text" value="{{ $unit->swimming_pool }}" id="swimming_pool" name="swimming_pool" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
@section('js')
    ...
    <script>
        ...
        @if($unit->land_size_width != 0 && $unit->land_size_length != 0)
            calculate_land_area();
        @endif
        @if($unit->building_size_width != 0 && $unit->building_size_length != 0)
            calculate_house_area();
        @endif
    </script>
@endsection