<header class="header fixed-top clearfix">
    <!-- logo start -->
    <div class="brand">
        <a href="/" class="logo"><img src="{{ asset('images/T&Go.png',true) }}"/> </a>
    ...
    <div class="top-nav clearfix">
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                <a  id="notes" data-toggle="dropdown" class="dropdown-toggle" href="#"><span class="notification-info">{{ trans('multiple.notification') }}</span>
            ...
            @if(!empty($locales))
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="{{ asset('images/world.gif',true)}}">
                        ...
                        @foreach($locales as $l)
                            <li>
                                <a href="{{ route('locale',$l->short_locale) }}">
                                    <img alt="" src="{{ asset('data/locales/'.$l->icon,true)}}" style="width: 30px;">&nbsp;<span
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    <img alt=""
                         src="{{ !empty(Auth::user()->photo) ? asset('data/users/'.Auth::user()->photo,true) : asset('images/no_profile.jpg',true)}}">
