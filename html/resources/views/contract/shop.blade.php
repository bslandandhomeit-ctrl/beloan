...
<table class="table table-p-1 table-contract-bordered">
    ...
    <tr>
    	...
    	<td width="250px">
    		<p class="pb-0">
    			{{ $loan->units->building_area }} ម៉្រែតការ៉េ
    		</p>
    ...
    <tr>
    	...
    	<td colspan="4">
    		<p class="pb-0">
                USD {{ khmerNumber($loan->UnitTypes->annual_management_fee) }} ({{khNumberWord($loan->UnitTypes->annual_management_fee) }}) ក្នុងមួយខែ            
    		</p>
    		<small><i>ដោយ​ត្រូវ​បង់​សរុប​មួយ​ឆ្នាំ​ម្តងៗ  ដោយ​គិត​លើ​មូលដ្ឋាន ស្មើ​នឹង​ចំនួន {{ $loan->UnitTypes->management_fee_per_square }} ({{ $loan->UnitTypes->management_fee_per_square }}) ក្នុង​មួយ​ម៉ែត្រ​ក្រឡា​ក្នុង​មួយ​ខែ នៃ​ទំហំ​ក្រឡា​ផ្ទៃ​ចំណែក​ឯកជន និង ទំហំ​ក្រឡា​ផ្ទៃ​ប្រើ​ប្រាស់​រួម​សរុប ដូច​មាន​ចែង​លម្អិត​ក្នុង​ប្រការ ៦ នៃ​កិច្ចសន្យា​នេះ។</i></small>
    	</td>
    </tr>
    <tr>
...
{{-- <div class="container">
    <div class="row my-4">
        <div class="col" style="height: 253px !important;">
        @if(array_key_exists('customer2_id_front',$attachment_array)) 
            <img src="{{ $attachment_array['customer2_id_front']['path'] }}" width="100%" class="img-fluid d-block" style="height: 253px !important;object-fit: contain;">
        @endif
        </div>
        <div class="col" style="height: 253px !important;">
        @if(array_key_exists('customer2_id_back',$attachment_array)) 
            <img src="{{ $attachment_array['customer2_id_back']['path'] }}" width="100%" class="img-fluid d-block" style="height: 253px !important;object-fit: contain;">
        @endif
        </div>
    </div>
</div> --}}
