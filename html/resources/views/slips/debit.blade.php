...
<section class="panel">
    <header class="panel-heading">
        <span>{{ trans('sidebar.slip_debit') }}</span>
        ...
        <div class="col-lg-6">
            <div class="panel-body">
                <div class="docmargin" style="width:770px;max-width:770px;min-width:770px;">
                    <?PHP if($jouralRequiry): ?>
                        <form id="my_form">
                            <table height="321" border="1" style="width:770px;max-width:770px;min-width:770px; font-size:11px; font-weight:">
                                <tbody>
                                <?PHP $jds = []; ?>
                                    <?PHP foreach($jouralRequiry as $jr): ?>
                                        <?PHP
                                    ...
                                    <?PHP foreach($jds as $jd_prop): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="10" valign="top"><span style="position:absolute; margin-top:10px;">ចំនួន/Amount</span>
                                                        <input type="text" style="width:73%;border:none;;float:right; height:30px;" placeholder="................." value="{{floatval($jd_prop->debit)}}">
