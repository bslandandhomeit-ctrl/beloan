            ...
            <div id="printArea" class="panel-body" style="padding: 45px !important;">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <p class="receipt_time">Receipt Time: {{ date('d-m-Y h:i:s A',time()) }}</p>
                    </div>
                    <div class="col-sm-4">
                ...
                <div style="margin: 0 20px;">
                    ...
                    {{ ($drawdown->account_name != ' ')?$drawdown->account_name : $customer_name1}}{{ ($customer_name2 != ' ')?$opt.$customer_name2: ''}}
                    </span> ទឹកប្រាក់ <b style="border: 1px solid;padding: 15px !important;"> <span class="horizontal_dotted_lines" style="width: 138px;/*170px;*/">$ {{ number_format($slips->amount,2) }}</span></b></p>
