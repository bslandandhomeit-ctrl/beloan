        ...
        <div class="col-sm-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form class="cmxform form-horizontal" method="post" action="{{route('add_project')}}" id="frmDealer"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="company_id">
                                        @foreach($company as $compan)
                                            <option value="{{ $compan->id }}">{{ $compan->branch_name}}</option>
                                        @endforeach
                                    </select>
                            </div>
                            </div>
                                    ...
                                    <div id="exTab2">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="english">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">{{ trans('dealer.name') }}<span class="red-color"> *</span></label>
                                                    <input type="text" id="dealer_en" name="dealer_en" class="form-control"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">{{ trans('dealer.address') }}</label>
                                            ...
                                            <div class="tab-pane" id="chinese">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">{{ trans('dealer.name') }}<span class="red-color"> *</span></label>
                                                    <input type="text" id="dealer_cn" name="dealer_cn" class="form-control"/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">{{ trans('dealer.address') }}</label>
                                                    <input type="text" id="address_cn" name="address_cn" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sale_representative_id" id="sale_representative_id" style="width:100%" class="select2">
                                        @foreach($sale as $sales)
                                            <option value="{{ $sales->id }}">{{ $sales->name.'-'.$sales->name_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="dynamic_code" name="dynamic_code" class="form-control" required/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="text-align: right;">
                                ...
                                <button type="reset" class="btn btn-warning"><i
                                            class="fa fa-refresh"></i>&nbsp;&nbsp;{{ trans('multiple.m_reset') }}
                                </button>
                            </div>
                            <br/><br/>
                        </div>
