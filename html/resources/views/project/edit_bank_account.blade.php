    ...
    <div class="col-sm-12">
        <section class="panel">
            ...
            <header class="panel-heading">
               {{ trans('dealer.del_edit_bank') }}
            </header>
            <div class="panel-body">
                <form class="cmxform form-horizontal" method="post" action="{{ route('edit_bank', [$bank->id]) }}" id="bankForm">
                   ...
                   <div class="form-group">
                       ...
                       <div class="col-sm-6">
                           <input type="text" name="account_name" id="account_name" value="{{$bank->account_name}}" class="form-control"/>
                       </div>
                   </div>
                   <div class="form-group">
                       <label class="col-sm-3 control-label">{{ trans('dealer.dl_dealer_account_number') }} <span class="red-color">*</span> </label>
                       <div class="col-sm-6">
                           <input type="text" name="account_number" id="account_number" value="{{$bank->account_number}}" class="form-control"/>
                       </div>
                   </div>
                   <div class="form-group">
                       <b/><br/>
