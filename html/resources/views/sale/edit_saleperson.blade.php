    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="panel">
                ...
                Sale Person : {{ trans('representative.edit') }}
                </header>
                <div class="panel-body">
                    ...
                    <form class="cmxform form-horizontal" method="post" action="{{route('edit_saleperson',[$representative->id])}}" id="frmDealer" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label">{{ trans('representative.name') }}<span class="red-color"> *</span></label>
                                    <input type="text" value="{{ $representative->name }}" id="name" name="name" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                ...
                                <option value="">Select sale team</option>
                                        <option value="1" {{ $representative->lavel?$representative->lavel == 1?'selected':'':old('representative') }}>Sale Team L1</option>
                                        <option value="2" {{ $representative->lavel?$representative->lavel == 2?'selected':'':old('representative') }}>Sale Team L2</option>
                                        <option value="3" {{ $representative->lavel?$representative->lavel == 3?'selected':'':old('representative')}}>Sale Team L3</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="gender" name="gender">
                                        <option value="male" {{ $representative->gender?$representative->gender == 'male'?'selected':'':old('representative') }}>Male</option>
                                        <option value="female" {{ $representative->gender?$representative->gender == 'female'?'selected':'':old('representative') }}>Female</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ $representative->dob }}" id="dob" name="dob" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <label class="control-label">{{ trans('representative.national_id') }} <span
                                    class="red-color">*</span></label>
                                <input type="text" value="{{ $representative->national_id }}" id="national_id" name="national_id" class="form-control" required/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $representative->phone }}" id="phone" name="phone" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">Lavel<span class="red-color"> *</span></label>
                                    <input type="text" value="{{ $representative->lavel }}" id="lavel" name="lavel" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">Commission rate<span class="red-color"> *</span></label>
                                    <input type="text" value="{{ $representative->com_rate }}" id="com_rate" name="com_rate" class="form-control" required/>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="control-label">commission level type<span class="red-color"> *</span></label>
                                    <input type="text" value="{{ $representative->com_level_type }}" id="com_level_type" name="com_level_type" class="form-control" required/>
                                </div>
                            </div>                            
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="text-align: right;">
                                <a href="/sale/saleperson-list"  class = "btn btn-secondary pull-right"> Cancel </a>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            var lavel = '<?php echo $representative->lavel;?>';
            var parent_id = '<?php echo $representative->parent_id;?>';
            if(lavel==2){
                    $(".sale_person_parent_l1").css('display','block');
                    $(".sale_person_parent_l2").css('display','none');
                    $("#sale_person_parent_l1").val(parent_id).trigger('change');
                }else if(lavel==3){
                    $(".sale_person_parent_l2").css('display','block');
                    $(".sale_person_parent_l1").css('display','none');
                    $("#sale_person_parent_l2").val(parent_id).trigger('change');
                }else if(lavel==1){
                    $("#sale_person_parent_l1").val('').trigger('change');
                    $("#sale_person_parent_l2").val('').trigger('change');
                }else{
