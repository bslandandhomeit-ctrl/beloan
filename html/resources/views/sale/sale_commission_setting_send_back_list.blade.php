...
<div class="row">
        ...
        <div id="printArea" class="ox-scroll">
            ...
            <h4 class="sch_title">Commission Setting send back list</h4>
                    ...
                    <tbody class="checkbox-group">
                        ...
                        <?php $i++;?>
                            ...
                            <!-- <td class="isVerticalalign" align="center"><input type="checkbox" id="{{ $i}}" name="comission_request[]" value="{{$d->id}}" /></td>  -->
                                ...
                                @elseif( $d->approval =='send_back')
                                <p class="btn btn-xs btn-danger">Send Back</p>
                                            @else
                                            <p class="btn btn-xs btn-primary">Approved</p>
                                            @endif
                                </td>
                                <td class="isVerticalalign" >{{ $d->commission_approve_by }}</td>     
                                <td><a href="{{ route('edit_unit_type', [$d->id])}}" class="btn btn-xs btn-default" title="Edit"><i class="fa fa-pencil"></i> Edit</a> 
                            </td>                            
                            </tr>
                        @endforeach
                    </tbody>
