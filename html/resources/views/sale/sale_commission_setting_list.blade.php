...
@endif
            ...
            <form role="form" class="cmxform form-horizontal" id="search_frm" method="get" action="{{ route('getRequestWithdrawCommissionList') }}">
            <div class="row">
                    <div class="col-md-3">                                            
        ...
        <div id="printArea" class="ox-scroll">
            ...
            <input type = "hidden" name = "sale_person" value = "{{ Request::get('sale_person') }}"/>
                ...
                <table class="table table-bordered table-striped table-condensed table-hover dealerTable" id="dealers_list">
                    ...
                    <th style="vertical-align:middle; text-align: center;">Commission type</th>                 
                    <th style="vertical-align: middle;text-align: center;">Commission value</th>
                    ...
                    <th style="vertical-align:middle; text-align: center;">Approve by</th>
                    ...
                    <tbody class="checkbox-group">
                        ...
                        <?php $i++;?>
                            ...
                            <!-- <td class="isVerticalalign" align="center"><input type="checkbox" id="{{ $i}}" name="comission_request[]" value="{{$d->id}}" /></td>  -->
                                ...
                                <td class="isVerticalalign">{{ !empty($d->start_date)?date('d-M-Y',strtotime($d->start_date)):"N/A" }}</td> 
                                <td class="isVerticalalign">{{ !empty($d->end_date)?date('d-M-Y',strtotime($d->end_date)):"N/A" }}</td> 
                                
                                <td class="isVerticalalign">
                                @if( $d->approval =='pending')
                                            <p class="btn btn-danger">Pending</p>
                                            @else
                                            <p class="btn btn-xs btn-primary">Approved</p>
                                            @endif
                                </td>
                                <td class="isVerticalalign" >{{ $d->commission_approve_by }}</td>     
                                <td><a href="{{ route('approvedCommissionSetting', [$d->id])}}" class="btn btn-xs btn btn-primary" title="Edit"><i class="fa fa-pencil"></i> Approved</a> 
                                <a href="{{ route('sendBackCommissionSetting', [$d->id])}}" class="btn btn-xs btn btn-warning" title="Send back"><i class="fa fa-undo"></i> Send back</a> 
                            </td>                            
                            </tr>
                        @endforeach
                    </tbody>
