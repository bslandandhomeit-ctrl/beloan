    ...
    <div class="col-sm-12">
        ...
        <section class="panel" style="margin: 0 auto;">
            <div id="printArea" class="panel-body" style="padding: 45px !important;">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <p class="posting_date">Withdrawal Date: {{ date('d-m-Y',strtotime($listSale->withdrawal_date)) }}</p>
                        <p class="receipt_time">Payment Status: @if( $listSale->payment_status =='Due')<span style="color: #fa8564">{{ $listSale->payment_status}}</span>
                          @else
                                    <span style="color:#1fb5ad">{{ $listSale->payment_status}}</span>
                                    @endif</p>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4 no" style="margin-top: 20px;">
                        <p style="text-align: left;">លេខ​ / <b>No</b> <span class="horizontal_dotted_lines dotted_width" style="width: 130px;">{{ $listSale->receipt_no }}</span> </p>
                    </div>
                </div>
                <div style="margin: 0 20px;">
                    <?php
                        ...
                        $opt=" & ";
                    ?>
                    <p>ប្រគល់អោយឈ្មោះ <span class="horizontal_dotted_lines" style="width: 295px;">
                    
                        @if(!empty($listSale->sale_commission_persons) && count($listSale->sale_commission_persons) > 0)
                        {{$listSale->sale_commission_persons->name}}
                    
                            @endif
                    
                </span> ទឹកប្រាក់ <b style="border: 1px solid;padding: 15px !important;"> <span class="horizontal_dotted_lines" style="width: 138px;/*170px;*/">$ {{ number_format($listSale->withdrawal_amount,2) }}</span></b></p>
                    <p class="p-english"></p>
