...
<section class="panel">
    <header class="panel-heading">
        <span>Sale Commission List</span>
...
@endif
            <form role="form" class="cmxform form-horizontal" id="search_frm" method="get" action="{{ route('list_sale_commission') }}">
            <div class="row">
                    <div class="col-md-3">                                            
        ...
        <div id="printArea" class="ox-scroll">
            ...
            @else
            <form role="form_request_withdraw" class="cmxform form-horizontal" id="form_request_withdraw" method="post" action="{{ route('request_all_withdraw') }}">
            @endif           
