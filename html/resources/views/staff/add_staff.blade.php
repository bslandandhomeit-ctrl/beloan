    ...
    <div class="col-sm-12">
        <section class="panel">
            <header class="panel-heading">
                {{ trans('sidebar.sb_add_new_staff') }}
                @foreach($branch as $b)
                @if(isset($branch_id))
                @if($branch_id==$b->id)
            ...
            <div class="panel-body">
                ...
                <form class="cmxform form-horizontal" method="post" action="{{route('add_staff')}}" id="staffForm" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ trans('user.id_card') }}</label>
                        <div class="col-sm-6">
                    ...
                    @if(count($branch) > 1)
                    <div class="form-group">
                        <label class="col-md-3 control-label">{{ trans('staff.s_staff_branch') }}<span class="red-color">*</span></label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ trans('multiple.m_email') }}<span class="red-color"></span></label>
                        <div class="col-sm-6">
                            <input  type="email" class="form-control" name="email" id="email"  data-fv-emailaddress="true"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="phone" id="phone" class="form-control" data-mask="999-999-999?9" placeholder="___-___-____"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ trans('multiple.m_phone',['num'=>2]) }} </label>
                        <div class="col-sm-6">
                            <input type="text" name="phone1" id="phone1" class="form-control" data-mask="999-999-999?9" placeholder="___-___-____"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ trans('staff.s_salary') }}<span class="red-color">*</span></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{ trans('staff.s_start_date') }}<span class="red-color">*</span></label>
                            <div data-date-viewmode="years" data-initialize="datepicker" data-date-format="dd/mm/yyyy" class="input-append date dpYears col-sm-6">
