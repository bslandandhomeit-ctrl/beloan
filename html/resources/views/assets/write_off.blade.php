...
@section('content')
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <form action="{{route('write_off_asset', [$res->id])}}" method="POST" class="cmxform form-horizontal" id="assetWriteOffForm">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <fieldset>
                    <div class="form-group">
                        <label class="control-label col-lg-5">{{trans('asset.net_book')}}<span class="red"> *</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="net_book" id="net_book" class="form-control" />
                        </div>
                    </div>
