...
@section('content')
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <form action="{{route('dispose_asset', [$res->id])}}" method="POST" class="cmxform form-horizontal" id="assetDisposeForm">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <fieldset>
                    <div class="form-group">
                        <label class="control-label col-lg-5">{{trans('asset.amount')}}<span class="red"> *</span></label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-5">{{trans('asset.dispose_to')}}<span class="red"> *</span></label>
                        <div class="col-lg-6">
                            <input type="text" name="a_to" id="a_to" class="form-control" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-lg-5">{{ trans('asset.approved_by') }}<span class="red"> *</span></label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-5">{{ trans('asset.remark') }}</label>
                        <div class="col-lg-6">
